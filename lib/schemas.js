...
const SITE_STRING_KEYS = [
  "storeName", "announcement", "bookTitle", "heroSubline", "endorsementQuote", "endorsementName",
  "endorsementCredentials", "ctaLabel", "amazonUrl", "amazonLabel", "releaseNote", "newsletterHeading",
  "newsletterBody", "contactIntro", "contactEmail", "privacyPolicy", "metaDescription",
];
...
// Express middleware factory: validates req[source] against a schema and
// replaces it with the parsed (typed, defaulted) value on success.
...
module.exports = {
  validate,
  newsletterSchema, contactSchema, orderSchema, loginSchema,
